      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-[#121212]">
        <div className="w-full max-w-md">
          <div className="flex flex-col items-center space-y-8">
            ...
            {/* Sign Up Header */}
            <h1 className="text-2xl font-bold text-white mb-6">Join CloudAI</h1>
            
            {/* Clerk SignUp - Custom Appearance */}
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 w-full max-w-lg">
            <div className="text-white space-y-6">
              <h2 className="text-2xl font-bold mb-4">Create your CloudAI account</h2>
